 ...
 * Objet
 *
 * @var Sources\HumourBundle\Entity\Objet : objet demandé
 */
	private $objet;

/**
 * Liste des id déjà vues. Permet de savoir quels objets ont déjà été inscrits dans la liste de noeuds, afin de n'en oublier aucun et de ne pas faire de doublons.
 *
 * @var array
 */
	private $listeId;
	 ...
	 * @param integer $allrelations : ensemble des relations possibles pour cette source de données
...
/**
	 * Après passage dans un noeud, recherche récursivement ses relations
	 *
	...
	public function trouve($recherche)
	{
		...
		else
		{
			...
			$query = $this -> getEntityManager() -> createQuery(
				'SELECT m
				FROM SourcesHumourBundle:Objet m
